          ...
          <div className="mb-6 flex items-center">
            ...
            <div className="relative ml-3">
              ...
              <div className="absolute inset-y-0 right-3 flex items-center pointer-events-none">
                <svg className="w-4 h-4 text-black font-medium cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            <div className="border-b pb-2">
              ...
              <div
                ...
                style={{
                  height: openDropdowns.shipping ? `${dropdownHeights.shipping || 0}px` : '0px',
            ...
            <div className="border-b pb-2">
              ...
              <div
                className="overflow-hidden transition-all duration-300 ease-in-out"
                style={{
                  height: openDropdowns.return ? `${dropdownHeights.return || 0}px` : '0px',
